                            ...
                            <FlatList
                                ...
                                renderItem={({item, index}) => (
                                    <View style={[styles.row, styles.flatListItem, index%2 == 0 ? styles.backgroundEven : styles.backgroundOdd]}>
                                        ...
                                        <View style={styles.withList}>
                                            <Text style={[styles.textAlignLeft, styles.textListItem]}>{this.reducedigit(item.water_level)}</Text>
                                        </View>
                                        <View style={styles.withList}>
                                            <Text style={[styles.textListItem, styles.textAlignLeft]}>{
                                                item.water_level > 1000 ? "Excellent":
                                                    item.water_level < 500 ? "Fair" : "Poor" 
                                            }</Text>
                                        </View>
                                    </View>
                            )}/>
