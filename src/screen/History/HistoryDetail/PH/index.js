                        ...
                        <>
                            <View style={[styles.row, styles.containerDetail]}>
                                ...
                                <View>
                                    ...
                                    <Text style={[styles.textDescDetail, styles.textAlignRight]}>{this.state.averageScore.ph}</Text>
                                </View>
                            </View>
                            ...
                            <FlatList
                                ...
                                renderItem={({item, index}) => (
                                    <View style={[styles.row, styles.flatListItem, index%2 == 0 ? styles.backgroundEven : styles.backgroundOdd]}>
                                        ...
                                        <View style={styles.withList}>
                                            <Text style={[styles.textAlignLeft, styles.textListItem]}>{this.reducedigit(item.ph)}</Text>
                                        </View>
                                        <View style={styles.withList}>
                                            <Text style={[styles.textListItem, styles.textAlignLeft]}>{
                                                item.ph == 7 ? "Excellent" : item.ph < 8.5 && this.state.averageScore.ph > 6.5 ? "Fair" : "Poor"
                                            }</Text>
                                        </View>
                                    </View>
                            )}/>
